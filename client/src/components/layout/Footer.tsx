    ...
    <footer className="bg-black text-white pt-16 pb-8 border-t border-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li><Link href="/join#planes" className="hover:text-white transition-colors">Nuestros Planes</Link></li>
        ...
        <div className="pt-8 border-t border-gray-900 text-center text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} GastroFlow. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
