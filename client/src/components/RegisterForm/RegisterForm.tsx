...
export default function RegisterForm() {
  ...
  const { registerNewUser, registerUserGoogle } = useContext(UsersContext);
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      Swal.fire({
        ...
        text: isEmailAlreadyRegistered
          ...
          : backendMessage ||
            "No fue posible registrar el usuario. Revisa los datos ingresados.",
        icon: "error",
      });
    },
  });
  ...
  return (
    <div className="w-full max-w-md overflow-hidden rounded-3xl bg-[#0a0e1e]/90 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)]">
      {/* BARRA SUPERIOR */}
      <Link
        href="/owner"
        className="flex items-center justify-center bg-linear-to-r from-orange-500 to-pink-500 px-4 py-4 text-center"
      >
        <div className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-orange-400 bg-orange-500/10 px-3 py-2 text-[11px] font-semibold text-white transition hover:bg-orange-800 sm:text-sm">
          <UtensilsCrossed className="h-4 w-4 shrink-0" />
          <span>¿Sos dueño de un restaurante? Registralo aquí</span>
        </div>
      </Link>
      ...
      <div className="px-5 py-6 sm:px-8 sm:py-8">
        ...
        <div className="mb-5 text-center">
          <h1 className="bg-linear-to-r from-orange-500 to-pink-500 bg-clip-text text-3xl font-bold text-transparent sm:text-4xl">
            GastroFlow
          </h1>
        ...
        <form className="flex flex-col gap-3" onSubmit={formik.handleSubmit}>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-3 rounded-xl border-2 border-orange-500/40 bg-white/4 px-3 py-3">
            ...
            {formik.errors.first_name && formik.touched.first_name && (
              <p className="text-xs text-red-400">{formik.errors.first_name}</p>
            )}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            {formik.errors.last_name && formik.touched.last_name && (
              <p className="text-xs text-red-400">{formik.errors.last_name}</p>
            )}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            {formik.errors.city && formik.touched.city && (
              <p className="text-xs text-red-400">{formik.errors.city}</p>
            )}
          </div>

          {/* PAÍS */}
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-white/80">País</label>
            ...
            {formik.errors.country && formik.touched.country && (
              <p className="text-xs text-red-400">{formik.errors.country}</p>
            )}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-[11px] leading-4 text-orange-400">
              La contraseña debe tener 8 a 15 caracteres, mayúscula, minúscula,
          ...
          {/* TÉRMINOS */}
          <div className="mt-1">
            <label className="flex cursor-pointer items-start gap-2 text-xs leading-5 text-white/50">
              <input
                type="checkbox"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="mt-2 flex w-full items-center justify-center gap-3 rounded-xl bg-linear-to-r from-orange-500 to-pink-500 px-5 py-3 text-sm font-semibold text-white shadow-[0_4px_15px_rgba(249,115,22,0.3)] transition hover:-translate-y-0.5 hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-50"
          >
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-xl border-2 border-white/5 bg-white/5 px-5 py-3 text-sm font-semibold text-white/70 transition hover:-translate-y-0.5 hover:bg-white/10 hover:text-white"
        >
