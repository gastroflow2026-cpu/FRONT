...
export const SuperAdminChatWidget = () => {
  ...
  const { connected, conversations, activeUserId, setActiveUserId, loadHistory, sendMessage } =
    useSuperAdminChat();
  ...
  // Lista de admins que han escrito (senders únicos)
  const adminList = Array.from(conversations.keys());
