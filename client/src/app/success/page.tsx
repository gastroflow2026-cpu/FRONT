      ...
      <main className="flex grow items-center justify-center px-4 py-24">
        <div className="w-full max-w-md rounded-3xl border border-gray-100 bg-white p-10 text-center shadow-lg">
          ...
          <p className="mb-8 text-gray-500">
            En breve recibirás un email con todos los detalles de tu reserva.
          </p>

          {/* Detalle visual */}
          <div className="mb-8 flex items-center gap-3 rounded-2xl border border-orange-100 bg-orange-50 p-4 text-left">
            <CalendarCheck size={22} className="shrink-0 text-orange-500" />
            <p className="text-sm text-orange-800">
              Recordá llegar con al menos <strong>10 minutos de anticipación</strong> para respetar tu reserva.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="/restaurants">
              <button className="w-full rounded-xl border border-gray-200 bg-gray-50 py-3 font-semibold text-gray-700 transition hover:bg-gray-100">
